...
With Literal AI you can create, debug and manage [prompts](/guides/prompt). If you are using [LangChain](/integrations/langchain) in your LLM application, you need to use a different format for prompts. In this guide, you will learn how to convert a Literal AI prompt to a [LangChain Chat Prompt Template](https://python.langchain.com/docs/modules/model_io/prompts/quick_start/#chatprompttemplate).
