...
The current scope for Online Evaluation is focused on LLM Generations and allows for you to classify LLM generations into categories of a [Score Template](score#from-the-application). 
