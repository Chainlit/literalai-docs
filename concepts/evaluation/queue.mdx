...
The Literal AI platform helps you organise and smoothen the human evaluation process by easily setting-up annotation queues.
...
You can access your queues on the "Annotation Queues" page, and create them by pressing the "+" cta in the top right corner of the table.
...
<Note>By default each project comes with a "Default" annotation queue.</Note>

## Populating a queue with data

With your queues created you can manually add items to review.
Accessing your run/generation logs, select them and insert them into the queue.
...
On the "Annotation Queues" page, you can open a specific queue, allowing users to start reviewing added items.

A reviewer can score and tags providing you with human feedbacks.
