...
The current scope for Online Evaluation is focused on LLM Generations and allows you to classify LLM generations into categories of a [Score Template](/concepts/monitoring/score#from-the-application). 
