...
The current scope for Online Evaluation is focused on LLM Generations and allows you to classify LLM generations into categories of a [Score Template](/concepts/observability/scores#from-the-application). 
...
<Frame caption="Correct Score Template">
  <img src="/images/correct-rule-score-template.png" alt="Correct Score Template" />
</Frame>

<Frame caption="Incorrect Score Template">
  <img src="/images/incorrect-rule-score-template.png" alt="Incorrect Score Template" />
</Frame>
