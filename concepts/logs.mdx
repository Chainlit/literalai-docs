---
title: Logs
description: Logs are essential to monitor and improve your LLM system in production. Literal AI provides a flexible and composable SDK to log your LLM system at different levels of granularity.
---
...
2. **Run**: Log a single invocation of an Agent/Chain invocation, including its intermediate steps. Can contain one or multiple generations.
3. **Thread**: Log a collection of runs that are part of a single conversation.

<Frame caption="A Thread containing a run and two generations in Literal AI">
  <img src="/images/threads-overview.png" alt="Literal AI Platform"/>
</Frame>
...
<Card title="TypeScript Step API reference"  color="#2662d9" icon="js" href="/python-client/abstractions/step">
...
<Card title="TypeScript Thread API reference"  color="#2662d9" icon="js" href="/python-client/abstractions/thread">
