...
Automating the evaluation of your [Run outputs or LLM generations](/concepts/logs#semantics) is essential to monitor and improve your LLM app in production.
