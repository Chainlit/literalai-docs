...
You can add tags to a [Thread](/concepts/thread), [Step](/concepts/step) or [Generation](/concepts/generation). Similar to Github labels, you can use tags to filter data both from the Literal AI UI and the clients. Tags are shared between units (Threads, Steps and Generations). 
