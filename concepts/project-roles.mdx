...
### Managing Literal API Keys

You can then navigate to the "Settings > General" tab in your project, access the "Literal API Keys" section, generate a new API key, and use it in your application.
