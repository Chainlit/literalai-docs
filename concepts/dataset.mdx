---
title: "Datasets"
description: "Datasets are at the core of your iteration cycle. They are a collection of input/expected output samples for conducting experiments and validations."
---
...
Key Value datasets can have any key-value pairs for input and expected output. This type of dataset can be used to for example store [Runs](/concepts/logs#semantics) of agents. An example of a Key Value dataset item:
