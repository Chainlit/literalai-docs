...
You can add [Tags](/concepts/thread/tags) and [Scores](/concept/score) to Generations. Additionally, you can add Generations to a [Dataset](/concepts/dataset), to use later on in for example Evaluation. 
