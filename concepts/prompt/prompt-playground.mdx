...
When you save a new prompt template, you give it a name. This name becomes the prompt's ID, so you cannot change this afterwards.  

When you save a new version of the prompt template, a screen will pop up with a diff comparison. In this changelog, like using Git, you can see what you have changed, before you save these changes. 
