...
You can add [Tags](/concepts/observability/tags) and [Scores](/concepts/evaluation/score) to Generations. Additionally, you can add Generations to a [Dataset](/concepts/evaluation/dataset), to use later on in for example Evaluation. 
