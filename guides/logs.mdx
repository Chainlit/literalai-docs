...
2. **Step**: Log of a regular function, which is usually an intermediate step in an LLM system. It can be `tool`, `embedding`, `retrieval`, `other`. Steps can be considered as Spans.
