...
- Agent run level (integration tests)
- Conversation level (end-to-end tests)
...
- Regularly have human experts review a subset of logged interactions
...
3. Pull the baseline performance metrics w.r.t to that dataset
