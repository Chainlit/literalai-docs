...
The source code of this notebook can be found in the Literal AI [Github Cookbooks](https://github.com/Chainlit/literal-cookbook/blob/main/evaluation/python/Context%20relevancy%20with%20Ragas.ipynb).
