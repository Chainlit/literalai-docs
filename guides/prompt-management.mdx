...
description: Prompt Management enables collaboration between software and product teams to create, version, A/B test, debug, and monitor prompts directly from Literal AI.
icon: message-code
---
