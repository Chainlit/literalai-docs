...
3. **LLM Generations**. You can investigate Generations from a real chat conversation and debug it directly from the playground.
...
You can also compare different LLMs in the playground by adding multiple tabs.
