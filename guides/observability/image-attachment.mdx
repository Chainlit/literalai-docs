---
title: Multimodal Conversation Logging with OpenAI and Literal AI
---
...
<CodeGroup>
```python Multimodal conversation with OpenAI and Literal AI
import os
...
The chat with attachment is displayed in a Literal AI Thread as follows: 
