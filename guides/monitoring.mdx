...
Monitoring is closely related to [evaluation](/guides/evaluation.mdx) and [continuous improvement](/guides/continuous-improvement.mdx).
...
- For detailed information on setting up evaluations, refer to our [evaluation guide](/guides/evaluation.mdx)
...
Detailed [logs](/guides/logs.mdx) provide valuable insights for troubleshooting and optimization:
