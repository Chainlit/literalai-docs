...
<CardGroup cols={2}>
<Card title="Python" icon="python" href="https://github.com/Chainlit/literal-cookbook">
  Check out this Python LangGraph example.
</Card>
<Card title="Typescript" icon="node" href="https://github.com/Chainlit/literal-cookbook/typescript/langchain-langgraph/README.md">
