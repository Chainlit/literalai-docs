...
You can add [Metadata](/guides/guide-tag-scores-metadata#metadata) and [Tags](/guides/guide-tag-scores-metadata#tags) to the steps generated via the instrumentation.
