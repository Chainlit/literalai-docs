...
1. [Logs:](/concepts/logs) Instrument your code with the Literal AI SDK to log your LLM app in production.

2. [Prompt Management:](/concepts/prompt-management) Safely create, A/B test, debug, and version prompts directly from Literal AI.

3. [Dataset:](/concepts/evaluation/dataset) Create datasets mixing production data and hand written examples to run non regression tests/experiments.

4. [Analytics:](/concepts/rule) Monitor the performance of your LLM app in production. View LLM metrics in a dashboard, set automated rules and gather product & user analytics.
...
<Card title="Create your First Prompt" icon="sparkles" color="#2eb88a" href="/concepts/prompt-management">
