...
icon: rocket
---
Literal AI is a collaborative **observability**, **evaluation** and **analytics** platform for building **production-grade LLM apps**. Literal AI offers [multimodal logging](/concepts/observability/multimodal), including vision, audio, and video.
...
<Card title="Instrument your Code" icon="code" color="#2662d9" href="/get-started/quick-start">
