...
1. [Logs:](/concepts/logs) Instrument your code with the Literal AI SDK to log your LLM system in production.

2. [Prompt Management:](/concepts/prompt) Safely create, A/B test, debug, and version prompts directly from Literal AI.

3. [Evaluation:](/concepts/evaluation/experiment) Create datasets mixing production data and hand written examples to run non regression tests.

4. [Analytics:](/concepts/monitoring) Monitor the performance of your LLM system in production. View LLM metrics in a dashboard, set automated rules and gather product & user analytics.
