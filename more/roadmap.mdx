...
We release a new [guide](/guides) or cookbook for every new feature in Literal AI.

Upcoming new features: 

### Roles and Orgs

Currently in Literal AI, you can define [`Roles` and `Projects`](/guides/settings/project-roles) for collaboration. The project management will be improved with more ganular control over permission:
