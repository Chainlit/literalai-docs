...
With A/B testing, you can compare the performance of two different prompts or LLM settings. You can already do an A/B test in your code ([docs](/concepts/monitoring/compare)), but with this development you will be able to: 
...
Currently in Literal AI, you can define [`Roles` and `Projects`](/concepts/settings/project-roles) for collaboration. The project management will be improved with more ganular control over permission:
