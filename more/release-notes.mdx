...
* We are in the process of splitting the different stages of step ingestion : upserting the step, updating participant information, etc... This will help with the overall performance of the platform.
