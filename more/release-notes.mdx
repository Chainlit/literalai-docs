...
Each major LLM provider now offers a single credential.  
Additional credentials should be created as Custom LLM providers.  

See [Credentials](/guides/settings/llm).
</Warning>
...
Check out [Score-based Rules](/guides/online-evals) to get started !
</Warning>
