...
To self host the Literal AI platform, you will need to deploy the Docker image on your infrastructure. The Docker image is available on a private registry. You will need to [contact us](https://docs.google.com/forms/d/e/1FAIpQLSdPVGqfuaWSC2DfunR6cY4C7kUHl0c2W7DnhzsF9bmMxrVpkg/viewform?usp=header) to get access to the registry.
