...
# DATABASE_SSL=true
# Optionally, set DATABASE_MAX_CONNECTIONS if you need to manage the size of the pg pool, default 10
# DATABASE_MAX_CONNECTIONS=10
# Optionally, set DATABASE_CONNECTION_TIMEOUT_MS if you need to manage the pg connection timeout, default 15000
...
<Warning>The [pgcrypto](https://www.postgresql.org/docs/current/pgcrypto.html) module is required. When using Azure you will need to manually [add the extension](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/concepts-extensions).</Warning>
...
- For [Google Cloud Storage](https://github.com/lrakai/google-cloud-storage-signed-urls/blob/master/README.md)
...
```bash
LITERAL_API_URL=https://my-literal.com
