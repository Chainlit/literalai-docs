...
```python
attachment = literal_client.api.create_attachment(
...
```python
attachment = literal_client.api.update_attachment(
    id="<ATTACHMENT_UUID>",
    update_params={
        "name": "my_attachment",
        "content_type": "text/plain",
...
```python
attachment = literal_client.api.get_attachment(id="<ATTACHMENT_UUID>")
```
...
```python
attachment = literal_client.api.delete_attachment(id="<ATTACHMENT_UUID>")
```
