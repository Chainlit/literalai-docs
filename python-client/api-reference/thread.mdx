...
thread = await client.api.create_thread(
    participant_id="c0bd9bf3-45f2-447b-ae67-d4c18ae06542",
...
```python
thread = await client.api.get_thread(id="da932cd3-9be5-4bfc-bdb9-27d4909e3c32")
```
...
updated_thread = await client.update_thread(
    id="da932cd3-9be5-4bfc-bdb9-27d4909e3c32",
    metadata=None,
    participant_id=None,
    environment=None,
    tags=None,
...
thread = await client.upsert_thread(
    thead_id="da932cd3-9be5-4bfc-bdb9-27d4909e3c32",
    metadata=None,
    participant_id=None,
    environment=None,
    tags=None
...
```python
await client.api.delete_thread(id="da932cd3-9be5-4bfc-bdb9-27d4909e3c32")
```
