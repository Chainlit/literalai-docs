...
Note that you should call the `client.langchain_callback()` method every time you need to need to pass a langchain callback.
...
<Frame>
  <img src="/images/langchain-callback.png" alt="A thread with an Langchain agent execution in the Chainlit platform" />
</Frame>