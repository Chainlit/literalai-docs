...
<ParamField path="root_run_id" type="uuid">
  The id of the root run step. This enables you to reference steps as part of a run.
</ParamField>
...
<ParamField path="scores" type="List[Score]" default="[]">
