...
When `client.thread` is called a thread ID is set in the context, both steps and messages use this thread id. After sending a step or message to the platform, a thread is created with the given ID if it does not exist yet.
