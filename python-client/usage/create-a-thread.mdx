...
The simplest way to create a thread is to use the `@client.thread` decorator on a function:
...
<Card
  title="Using the API"
  icon="circle-nodes"
  href="/python-client/api-reference/entities#thread"
>
  You can also manipulate threads directly using the API.
</Card>
