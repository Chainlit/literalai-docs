...
[Scores](/concepts/score) allow you to manually evaluate user interactions with your application and LLM, which can be used to improve the performance and accuracy of your system. Scores can be human generated (human feedback, like a thump up or down), or AI generated (hallucination evaluation for instance). A score or feedback can be assigned to a Step, DatasetExperimentItem or Generation. Scores can be visualized on the dashboard in charts, and data can be filtered by scores.
